...
/*NOTE WE CANNOT FILL INT_MAX USING memset().  
  Because, second Parameter in memset() is a single byte therefore it fills -1 in place of INT_MAX, program may give error.*/
